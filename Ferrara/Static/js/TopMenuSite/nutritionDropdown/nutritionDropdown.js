...
exports.nutritionDropDownOnloadFunc = function (domObjDropDown) {
    if (domObjDropDown === void 0) { domObjDropDown = DOMOBJDROPDOWN(); }
    var dropDownDisplayName = domObjDropDown.dropDownDisplayName, anchor = domObjDropDown.anchor, nutritionFacts = domObjDropDown.nutritionFacts, dropDownDiv = domObjDropDown.dropDownDiv;
...
exports.nutritionDropDownFunc = function (node, domObj) {
    if (domObj === void 0) { domObj = DOMOBJDROPDOWN(); }
    var dropDownDisplayName = domObj.dropDownDisplayName, nutritionFacts = domObj.nutritionFacts;
    for (var i = 0; i < dropDownDisplayName.length; i += 1) {
...
if (typeof process === "undefined")
    exports.nutritionDropDownOnloadFunc();
