...
;
var DOMOBJCAROUSEL = function DOMOBJCAROUSEL() {
    return {
        ...
        carouselIndicatorsRoot: document.getElementsByClassName("carousel-indicators"),
...
exports.carouselOnloadFunc = function (domObjCarousel) {
    if (domObjCarousel === void 0) {
        domObjCarousel = DOMOBJCAROUSEL();
    }
    var unfilteredCarouselEl = domObjCarousel.unfilteredCarouselEl,
        carouselRoot = domObjCarousel.carouselRoot,
        carouselIndicatorsRoot = domObjCarousel.carouselIndicatorsRoot,
        carouselExampleIndicators = domObjCarousel.carouselExampleIndicators,
        carouselEl = domObjCarousel.carouselEl;
    ...
    if (carouselEl.length > 1) {
        for (var i = 0; i < carouselEl.length; i += 1) {
            ...
            carouselIndicatorsRoot[0].appendChild(domLi);
        }
        ;
    } else {
...
if (typeof process === "undefined") exports.carouselOnloadFunc();
