...
const DOMOBJCAROUSEL: Function = (): IDomObjCarousel => {
    return {
        unfilteredCarouselEl: document.getElementsByClassName("carousel-inner")[0].getElementsByClassName("keeblerimageblock") as HTMLCollectionOf<HTMLElement>,
...
const carouselOnloadFunc: Function = (domObjCarousel: IDomObjCarousel = DOMOBJCAROUSEL()): IDomObjCarousel => {
