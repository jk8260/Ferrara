...
namespace Ferrara.Common
{
        ...
        where T : SitePageData
    {
        ...
        public string SiteName
        {
            get
            {
                var startPage = ContentLoader.Service.Get<StartPageBase>(SiteDefinition.Current.StartPage);
                return startPage.SiteName;
            }
        }
        ...
        public virtual string Layout
        {
            get
            {
                var page = PageContext.Page as SitePageData;
                if (page == null)
                    throw new NotImplementedException("Unable to resolve layout");

                return string.Format("~/Sites/{0}/Shared/Layouts/_Root.cshtml", SiteName);
            }
        }
    }
}